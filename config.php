...
//EUM 추가 경로
define('EUM_CSS_DIR',        '/src/css');
define('EUM_JS_DIR',         '/src/js');
define('EUM_PLUGIN_DIR',     '/src/plugin');

define('EUM_JS_URL',         G5_URL.'/'.EUM_JS_DIR);
define('EUM_CSS_URL',        G5_URL.'/'.EUM_CSS_DIR);
define('EUM_PLUGIN_URL',     G5_URL.'/'.EUM_PLUGIN_DIR);

define('EUM_INCLUDE_DIR',      'include');

define('EUM_INCLUDE_PATH',      G5_PATH.'/'.EUM_INCLUDE_DIR);
//==============================================================================
