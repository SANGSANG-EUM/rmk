...
add_javascript('<script src="'.EUM_PLUGIN_URL.'/scrollbar/lenis.js"></script>', 0);
add_javascript('<script src="'.EUM_PLUGIN_URL.'/niceselect/jquery.nice-select.min.js"></script>', 0);
