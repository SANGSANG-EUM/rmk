<div id="product_view" class="sub">
  <div class="sub-body">
    <section class="product-v_top sub-content">
      <div class="container">
        <div class="wrapper">
          <div class="inner">
            <div class="lt">
              <div class="product-v_pic">
                <div class="big">
                ...
                <div class="small">
                  <div class="swiper-container">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <img src="/src/img/sunglass-thumb.png" alt="">
                      </div>
                      <div class="swiper-slide">
                        <img src="/src/img/sunglass-thumb.png" alt="">
                      </div>
                    ...
                    <button type="button" class="ui-btn swiper-navi prev-btn"></button>
                    <button type="button" class="ui-btn swiper-navi next-btn"></button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="product-v_rel sub-content">
      <div class="container">
        <div class="wrapper">
          <div class="inner">
    ...
    <section class="product-v_detail sub-content">
      <div class="container">
        <div class="wrapper">
          <div class="inner">

            <div class="sec-mt dalton-logo">
              <img src="/src/img/dalton-logo.svg" alt="Dalton Logo">
            </div>

            <div class="sec-mt imgList">
              <ul>
                <li>
                  <img src="/src/img/product-view-detail_img1.jpg" alt="">
                </li>
                <li>
                  <img src="/src/img/product-view-detail_img2.jpg" alt="">
                </li>
                <li>
                  <img src="/src/img/product-view-detail_img3.jpg" alt="">
                </li>
                <li>
                  <img src="/src/img/product-view-detail_img4.jpg" alt="">
                </li>
                <li>
                  <img src="/src/img/product-view-detail_img5.jpg" alt="">
                </li>
                <li>
                  <img src="/src/img/product-view-detail_img6.jpg" alt="">
                </li>
              </ul>
            </div>
